...
apps = App.create([
  {name: 'Language8020', description: 'Language learning application. Based on the premise that 80% of a person\'s daily conversation is derived from 20% of one\'s vocabulary.', url: 'language-80-20.herokuapp.com', tags: [rails, javascript, jquery, rspec]},
